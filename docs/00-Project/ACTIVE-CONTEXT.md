...
- **Arquitectura:** Fases 4A–4C, 5A, 5B y 5C cerradas; sigue Fase 6 (consolidación del plan en Compra: los ingredientes faltantes de las recetas planificadas se añaden a Compra como fuente trazable, sin duplicados y sin fusionar unidades incompatibles, preservando los productos manuales e informando por toast de los añadidos) según el plan maestro. El cálculo de faltantes ya existe en `src/modules/plan/suggestions.ts` y es el punto natural de reutilización.
