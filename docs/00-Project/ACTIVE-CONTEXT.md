...
- **Fase 3, bloque 2 (UI DESPENSA) en curso** en `feature/pantry-catalog`: lista priorizada, detalle y alta de producto mediante `pantry_record_entry`, reutilizando el panel responsive del nodo Figma `31:212`. Las acciones D3 de terminar/ajustar y su integración opcional con Compra siguen pendientes.
