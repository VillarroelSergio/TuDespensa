...
- **Arquitectura:** Fases 4A–4C, 5A y 5B cerradas; sigue Fase 5C (sugerencias explicables: ranking determinista de exactamente tres recetas elegibles, con factores visibles de disponibilidad, productos prioritarios, preferencias, variedad, repetición, tiempo y orientación mediterránea, y pesos versionados) según el plan maestro. El selector P2 ya existe en `/plan/elegir` y es donde deben aparecer esas tres sugerencias por encima de la búsqueda.
