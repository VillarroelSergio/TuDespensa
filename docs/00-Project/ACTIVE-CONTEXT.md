...
- **Selector de Plan móvil (2026-07-28):** los filtros por ingrediente se desplazan horizontalmente en móvil (sin aumentar innecesariamente la altura), el selector comunica el número de recetas disponibles y cada tarjeta muestra la acción «Elegir» sin perder que toda la tarjeta es pulsable.
