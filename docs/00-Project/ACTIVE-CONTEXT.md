...
- **Arquitectura:** Fases 4A–4C y 5A cerradas; sigue Fase 5B (selección y edición del plan: selector P2 de recetas guardadas para un hueco concreto, asignación directa al elegir, y cambiar receta / ajustar raciones / mover / eliminar con confirmación y Deshacer) según el plan maestro. Las RPC `plan_set_meal` y `plan_clear_meal` ya están disponibles para 5B.
