...
- **Hotfix de estabilidad — tormenta de mutaciones obsoletas (2026-07-28):** diagnóstico, decisión y evidencia post-despliegue en [[TECHNICAL-ARCHITECTURE#6.1 Incidente de tormenta de mutaciones obsoletas (piloto, 2026-07-28)]]. Las migraciones `20260728163451_fix_idempotency_version_race.sql` y `20260728170658_graceful_optimistic_conflicts.sql` están aplicadas a producción; la segunda redujo la medición a 0 rollbacks en una ventana de 19,486 s. Queda observar una sesión normal del piloto y decidir explícitamente si se revoca alguna sesión.
